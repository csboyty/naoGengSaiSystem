    ...
    <div id="collapse5" class="panel-collapse collapse in" aria-labelledby="heading5">
        <div class="panel-body">
            <form class="form-horizontal">
                ...
                <div class="form-group">
                    <label class="control-label col-md-2">出血病因分型</label>

                    <div class="col-md-8">
                        <?php
                        $bingYinFenXingArray = array("动脉瘤","动静脉畸形","脑底异常血管网病",
                            "夹层动脉瘤","血管炎","静脉窦血栓","原发性中脑周围出血","其他原因");
                        $bingYinFenXingSel = "";
                ...
                <div class="form-group">
                    <label class="control-label col-md-2">动脉瘤位置</label>

                    <div class="col-md-8">
                        <?php
                        $liuWeiZhiArray = array("后交通动脉和颈内动脉交界处","前交通动脉","大脑前动脉",
                            "大脑中动脉","基地动脉尖端","椎动脉与小脑后下动脉连接处");
                        $liuWeiZhiSel = "";

                        if ($other && $other->liuWeiZhi) {
                            $liuWeiZhiSel = $other->liuWeiZhi;
                        }

                        foreach ($liuWeiZhiArray as $lwza) {
                            $liuWeiZhiChecked = "";
                            if ($liuWeiZhiSel == $lwza) {
                                $liuWeiZhiChecked = " checked ";
                            }

                            ?>

                            <label class="radio-inline">
                                <input type="radio" <?= $liuWeiZhiChecked; ?> value="<?= $lwza; ?>"
                                       data-name-parent="other"
                                       name="liuWeiZhi"><?= $lwza; ?>
                            </label>
                        <?php
